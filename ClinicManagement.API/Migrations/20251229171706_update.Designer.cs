...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClinicManagement.API.Entities.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("ClinicManagement.API.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ClinicManagement.API.Entities.Operation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ClinicManagement.API.Entities.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ClinicManagement.API.Entities.ServiceType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ClinicManagement.API.Entities.Stay", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ClinicManagement.API.Entities.ApplicationUser", b =>
                {
                    b.OwnsMany("ClinicManagement.API.Entities.RefreshToken", "RefreshTokens", b1 =>
                        {
                    ...
                    b.OwnsOne("ClinicManagement.API.Entities.UploadedFile", "ProfileImage", b1 =>
                        {
            ...
            modelBuilder.Entity("ClinicManagement.API.Entities.Appointment", b =>
                {
                    ...
                    b.HasOne("ClinicManagement.API.Entities.ApplicationUser", "UpdatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("ClinicManagement.API.Entities.Invoice", b =>
                {
                    ...
                    b.HasOne("ClinicManagement.API.Entities.ServiceType", "ServiceType")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("ClinicManagement.API.Entities.Patient", b =>
                {
                    ...
                    b.HasOne("ClinicManagement.API.Entities.ApplicationUser", "User")
                        .WithOne("Patient")
                        .HasForeignKey("ClinicManagement.API.Entities.Patient", "UserId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("ClinicManagement.API.Entities.Payment", b =>
                {
                    b.HasOne("ClinicManagement.API.Entities.Appointment", "Appointment")
                        .WithOne("Payment")
                        .HasForeignKey("ClinicManagement.API.Entities.Payment", "AppointmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ClinicManagement.API.Entities.Invoice", "Invoice")
                        .WithOne("Payment")
                        .HasForeignKey("ClinicManagement.API.Entities.Payment", "InvoiceId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("ClinicManagement.API.Entities.Review", b =>
                {
                    ...
                    b.HasOne("ClinicManagement.API.Entities.Patient", null)
                        .WithMany("Reviews")
                        .HasForeignKey("PatientId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("ClinicManagement.API.Entities.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ClinicManagement.API.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
