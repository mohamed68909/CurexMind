...
namespace CurexMind.API.Migrations
{
    ...
    [Migration("20260718171009_AddDefaultPatientUser")]
    partial class AddDefaultPatientUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CurexMind.API.Entities.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("CurexMind.API.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = "5F24506C-D3C0-4AE3-8616-5EB95A764359",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "DE9E600E-ECD5-4400-92E6-986F63EEC954",
                            Email = "Patient@mohamed.com",
                            EmailConfirmed = true,
                            FullName = "Ali Hassan",
                            IsDisabled = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "PATIENT@MOHAMED.COM",
                            NormalizedUserName = "PATIENT@MOHAMED.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEKj70KPmPc7BxyRhD9MuptCGolRkbmTp27lM/5HLVQxdU/qZw0HwYDAGR9JyB4c19Q==",
                            PhoneNumber = "01234567891",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "3FCB053BC1F041F2B07D3E7608D8020F",
                            TwoFactorEnabled = false,
                            UserName = "Patient@mohamed.com"
                        });
                });

            modelBuilder.Entity("CurexMind.API.Entities.Appointment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CurexMind.API.Entities.Clinic", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CurexMind.API.Entities.Invoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CurexMind.API.Entities.Operation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CurexMind.API.Entities.Patient", b =>
                {
                    b.Property<Guid>("PatientId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UserId = "5F24506C-D3C0-4AE3-8616-5EB95A764359"
                        });
                });

            modelBuilder.Entity("CurexMind.API.Entities.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CurexMind.API.Entities.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CurexMind.API.Entities.ServiceType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CurexMind.API.Entities.Stay", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = "5F24506C-D3C0-4AE3-8616-5EB95A764359",
                            RoleId = "4D447E8A-B35A-4DAE-BCE3-4552BF828693"
                        });
                });
            ...
            modelBuilder.Entity("CurexMind.API.Entities.ApplicationUser", b =>
                {
                    b.OwnsMany("CurexMind.API.Entities.RefreshToken", "RefreshTokens", b1 =>
                        {
                    ...
                    b.OwnsOne("CurexMind.API.Entities.UploadedFile", "ProfileImage", b1 =>
                        {
            ...
            modelBuilder.Entity("CurexMind.API.Entities.Appointment", b =>
                {
                    b.HasOne("CurexMind.API.Entities.Clinic", "Clinic")
                    ...
                    b.HasOne("CurexMind.API.Entities.Invoice", "Invoice")
                        .WithMany()
                        .HasForeignKey("InvoiceId");

                    b.HasOne("CurexMind.API.Entities.Patient", "Patient")
                        .WithMany("Appointments")
                        .HasForeignKey("PatientId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("CurexMind.API.Entities.ApplicationUser", "UpdatedBy")
                        .WithMany()
                        .HasForeignKey("UpdatedById");

                    b.HasOne("CurexMind.API.Entities.ApplicationUser", "user")
                        .WithMany()
                        .HasForeignKey("userId");
            ...
            modelBuilder.Entity("CurexMind.API.Entities.Invoice", b =>
                {
                    ...
                    b.HasOne("CurexMind.API.Entities.ServiceType", "ServiceType")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("CurexMind.API.Entities.Patient", b =>
                {
                    ...
                    b.HasOne("CurexMind.API.Entities.ApplicationUser", "User")
                        .WithOne("Patient")
                        .HasForeignKey("CurexMind.API.Entities.Patient", "UserId")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("CurexMind.API.Entities.Payment", b =>
                {
                    b.HasOne("CurexMind.API.Entities.Appointment", "Appointment")
                        .WithOne("Payment")
                        .HasForeignKey("CurexMind.API.Entities.Payment", "AppointmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CurexMind.API.Entities.Invoice", "Invoice")
                        .WithOne("Payment")
                        .HasForeignKey("CurexMind.API.Entities.Payment", "InvoiceId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("CurexMind.API.Entities.Review", b =>
                {
                    ...
                    b.HasOne("CurexMind.API.Entities.Patient", null)
                        .WithMany("Reviews")
                        .HasForeignKey("PatientId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("CurexMind.API.Entities.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CurexMind.API.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
