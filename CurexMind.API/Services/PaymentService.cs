...
using CurexMind.API.Contracts.Payment.Requests;
using CurexMind.API.Contracts.Payment.Responses;
using CurexMind.API.Entities;
using CurexMind.API.Errors;
...
namespace CurexMind.API.Services
{
    public class PaymentService : IPaymentService
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            if (!isAdmin && appointment.Patient.UserId != userId)
                return Result.Failure<PaymentResponse>(UserErrors.AccessDenied);
